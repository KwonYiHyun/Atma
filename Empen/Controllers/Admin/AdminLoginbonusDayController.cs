...
namespace Empen.Controllers.Admin
{
    ...
    public class AdminLoginbonusDayController : ControllerBase
    {
        ...
        {
            var loginbonus = await _masterContext.master_daily_login_bonus_day
                .FirstOrDefaultAsync(p => p.daily_login_bonus_day_id == loginbonusDto.daily_login_bonus_day_id);
        ...
        {
            bool exists = await _masterContext.master_daily_login_bonus_day
                .AnyAsync(l => l.daily_login_bonus_day_id == loginbonusDto.daily_login_bonus_day_id);
