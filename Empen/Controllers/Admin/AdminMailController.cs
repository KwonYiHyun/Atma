...
namespace Empen.Controllers.Admin
{
    ...
    public class AdminMailController : ControllerBase
    {
        ...
        {
            var mail = await _masterContext.master_mail
                .FirstOrDefaultAsync(m => m.mail_id == mailDto.mail_id);
        ...
        {
            bool exists = await _masterContext.master_mail
                .AnyAsync(m => m.mail_id == mailDto.mail_id);
